 ...
 */
   ...
   , function(e, t, n) {
       (function(t) {
           e.exports.maxScreenWidth = 2920,
               e.exports.maxScreenHeight = 2080,
               ...
               e.exports.nameY = 34,
               e.exports.skinColors = ["#bf8f54", "#cbb091", "#00ff00", "#00ffff", "rgba(0, 0, 0, 0)", "#ff4500", "#0000ff", "#ff0000", "#738cc3", "#9100ff"],
               e.exports.animalCount = 7,
               e.exports.aiTurnRandom = .106,
               e.exports.cowNames = ["Bruh", "Bruh"],
   ...
   , function(e, t, n) {
       ...
       var at = document.getElementById("featuredYoutube"),
           ot = [{
               ...
               name: "Engine Master",
               link: "https://www.youtube.com/channel/UC025RaCOpwq0RvcFt7Ipr4w?view_as=subscriber"
           }],
       ...
       function pt() {
           ...
           n += "<option disabled>All Servers - " + i + " players</option>",
               xe.innerHTML = n,
               "sandbox.moomoo.io" == location.hostname ? (e = "Back to Normal",
                                                           t = "//moomoo.io/") : (e = "The sandbox",
                                                                                  t = "//sandbox.moomoo.io/"),
           ...
           27 == t ? Qt() : R && R.alive && kn() && (gn[t] || (gn[t] = 1,
                                                               69 == t ? r.send("7", 1) : 67 == t ? (Mt || (Mt = {}),
                                                                                                     ...
                                                                                                     Mt.y = R.y) : 88 == t ? (R.lockDir = R.lockDir ? 0 : 1,
                                                                                                                              r.send("7", 0)) : null != R.weapons[t - 49] ? Sn(R.weapons[t - 49], !0) : null != R.items[t - 49 - R.weapons.length] ? Sn(R.items[t - 49 - R.weapons.length]) : 81 == t ? Sn(R.items[0]) : 80 == t ? xn() : mn[t] ? bn() : 32 == t && (O = 1,
        vn())))
       }
                                                         ))),
       ...
       function Un(e, t) {
           if (R.upgradePoints = e,
               ...
               _n.length ? (Ve.style.display = "block",
                            ...
                            qe.innerHTML = "Select (" + e + ")") : (Ve.style.display = "none",
                                                                    qe.style.display = "none",
                                                                    Tt())
           } else
       ...
       function Dn(e, t, n) {
           null != e && (R.XP = e),
               ...
               n == o.maxAge ? (ze.innerHTML = "MAX AGE",
                                He.style.width = "100%") : (ze.innerHTML = "AGE " + R.age + " [" + R.XP + "/" + R.maxXP + "]",
       ...
       function ni(e) {
           ...
           if (!i) {
               ...
               r.width = r.height = 2.1 * e.scale + 3;
       ...
       function ri(e, t) {
           ...
           if (!n || t) {
               ...
               i.width = i.height = 2.5 * e.scale + 3 + (l.list[e.id].spritePadding || 0);
               var r = i.getContext("2d");
               if (r.translate(i.width / 2, i.height / 2),
                   r.rotate(t ? 0 : Math.PI / 2),
                   r.strokeStyle = it,
                   r.lineWidth = 3 * (t ? i.width / 81 : 1),
                   "apple" == e.name) {
                   r.fillStyle = "#c15555",
                       si(0, 0, e.scale, r),
                       r.fillStyle = "#89a54c";
            ...
            be.fillRect(0, o.mapScale - o.snowBiomeTop - d, oe, ce - (o.mapScale - o.snowBiomeTop - d))),
               ...
               for (be.globalAlpha = 1,
                   ...
                   if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ == R || _.team && _.team == R.team)) {
                       var w = (_.team ? "〖" + _.team + "〗" : "〖〗") + ("! " + _.name + " !"||"") + (_.isPlayer&&_.sid? "[ID:" + _.sid + "]" : "~~");//player id
                       if ("" != w) {
                           if (be.font = (_.nameScale || 25) + "px Hammersmith One",
                               be.fillStyle = PNC,
                       ...
                       if(coord == true){
                           if(R.isPlayer) {
                               be.textAlign = "center",//coordinates number
                                   be.fillStyle = CNC,
                                   be.lineJoin = "round",
                                   be.font = "20px Hammersmith One",
                                   be.strokeStyle = "black",
                                   be.lineWidth = 6,
                                   be.strokeText(`\n⇦⇨ / X :${Math.round(_.x)} | ⇧⇩ / Y :${Math.round(_.y)}`,_.x - f,_.y - d + _.scale + o.nameY+(56)),
                                   be.fillText(`\n⇦⇨ / X :${Math.round(_.x)} | ⇧⇩ / Y :${Math.round(_.y)}`,_.x - f,_.y - d + _.scale + o.nameY+(56))
                           };
                       }
                       if(radarclan == true){
                           if(_.isPlayer&&_!=R&&_.team&&_.team==R.team){//tribe tracers
                               ...
                               be.stroke();
                               be.strokeStyle = nt;
                               be.fillText(`\nTEAM`,_.x - f,_.y - d + _.scale + o.nameY+(-72))
                           }
                       }
                       if(radarenemy == true){
                           if(_.isPlayer&&_!=R&&(_.team!=R.team||!_.team)){//enemy tracers
                               ...
                               be.stroke();
                               be.strokeStyle = nt;
                               be.fillText(`\nENEMY`,_.x - f,_.y - d + _.scale + o.nameY+(-72))
                           }
                       }
                       if(radaranimal == true){
                           if(!_.isPlayer){//animal tracers
                               ...
                               be.stroke();
                               be.strokeStyle = nt;
                               be.fillText(`\nANIMAL`,_.x - f,_.y - d + _.scale + o.nameY+(-102))
                           }
                       }
                       if(radarleader == true){
                           if(_.isPlayer&&_.isLeader){//leader tracers
                               ...
                               be.stroke();
                               be.strokeStyle = nt;
                               be.fillText(`\nLEADER`,_.x - f,_.y - d + _.scale + o.nameY+(-72))
                           }
                       }
                       if(radartopkiller == true){
                           if(_.isPlayer&&_.skull){//top killer tracers
                               be.fillStyle = TKRC,
                                   be.lineCap = "round";
                               be.strokeStyle = TKRC;
                               be.lineWidth = 3;
                               ...
                               be.stroke();
                               be.strokeStyle = nt;
                               be.fillText(`\nKILLER`,_.x - f,_.y - d + _.scale + o.nameY+(-72))
                           }
                       }
                       if(radarName == true){
                           if(_!=R&&_.isPlayer) {//name on tracers
                               be.font = (_.nameScale || 25) + "px Hammersmith One",
                                   ...
                                   be.lineJoin = "round",
                                   be.strokeStyle = "black",
                                   be.strokeText(_.name ,(R.x-f + _.x-f)/2,(R.y-d +_.y-d)/2),
                                   be.fillText(_.name ,(R.x-f + _.x-f)/2,(R.y-d +_.y-d)/2)
                           }
                       }
   ...
   , function(e, t) {
       e.exports = function(e, t, n, i, r, s, a, o, c) {
           this.aiTypes = [{
               ...
               id: 6,
               name: "8000 Gold, 100 Food [Moostafa]",
               nameScale: 50,
               src: "enemy",
               hostile: !0,
               dontRun: !0,
               ...
               id: 7,
               name: "5000 Gold, 0 Food [Treasure]",
               hostile: !0,
               nameScale: 35,
               src: "crate_1",
               fixedSpawn: !0,
               ...
               id: 8,
               name: "4OOO Gold, 1000 Food [Moofie]",
               src: "wolf_2",
               hostile: !0,
               fixedSpawn: !0,
               dontRun: !0,
...
var radarclan = true;
var radarenemy = true;
var radaranimal = false;
var radarleader = false;
var radartopkiller = false;
var radarName = true;
var TRC = "#00FF00";
var ERC = "#FF0000";
var ARC = "#0000FF";
...
function animate(space, chance) {
    ...
    let characters;
    if(space) {
        characters = '|DaiZo Mod| OP MoD |2021|';
    } else {
        characters = 'DaiZo';
    }
    if(space) {
...
function gameName(color){
    document.getElementById("gameName").style = "color:" + color + "; font-size:100px; text-shadow:none;";
}
function gameName2(name){
...
var lid = document.getElementById("leaderboard").append('•๖ۣۜDαĭ๖ۣۜZσ ๖ۣۜM๖ۣۜOɗ•');
document.getElementById("leaderboard").style = "font-size:20px;";
...
const healer2 = repeater(81, () => {placeQ(foodType, boostDir);
                                    placeQ(foodType, boostDir);
                                    placeQ(foodType, boostDir)}, 50);
const boostPlacer = repeater(97, () => {
                    for (let i=0;i<4;i++){
            let angle = myPlayer.dir + toRad(i * 90);
    place(boostType, angle);
                    }
}, 0);
const fourSpawnpader = repeater(103, fourSpawnpad, 0);
...
//KeyCode event
    ...
    if (e.keyCode == 13 && enter == false) {
        ...
        if (e.keyCode == 36 && enter == false) {
            doNewSend(["ch", ['Katana + Musket']]);
        doNewSend(["6", [4]]);
        doNewSend(["6", [15]]);
    }

    if (e.keyCode == 96 && enter == false) {
        if (cek == true) {
            autoQ = false;
        }
        autoprimary = true;
    ...
    if (e.keyCode == bullHelmet_bloodWings && enter == false) {
        e.preventDefault();
        doNewSend(["ch", ['Bull Helmet + Blood Wings']]);
        hat(7);
       acc(18);
    }
    if (e.keyCode == empHelmet_shadowWings && enter == false) {
        e.preventDefault();
                doNewSend(["ch", ['Emp Helmet + Shadow Wings']]);
        hat(22);
       acc(19);
    }
    if (e.keyCode == 112 && autoQ == false) {
        cek = true;
        doNewSend(["ch",['true']]);
        e.preventDefault();
        autoQ = true;
    } else if (e.keyCode == 112 && autoQ == true) {
        cek = false;
        doNewSend(["ch",['false']]);
        e.preventDefault();
        autoQ = false;
    ...
    if (e.keyCode == 192 && instaSpeed == 220) {
        doNewSend(["ch", ['    Fast Insta    ']]);
        instaSpeed = 210;
    } else if (e.keyCode == 192 && instaSpeed == 210) {
        doNewSend(["ch", ['    Normal Insta    ']]);
        instaSpeed = 220;
    }
})
...
#setupCard, #rightCardHolder, #linksContainer2,#joinPartyButton,#partyButton{
background-color: #68166fad;
border-style: solid;
border-color: #b12afd;
border-width: 5px;
border-radius: 30px;
...
if (e.which == 2 && messageToggle == 0) {
messageToggle = 1;
} else if (e.which == 2 && messageToggle == 1) {
    messageToggle = 0;
}
}, false);

var bullHelmet_bloodWings = 75;
var empHelmet_shadowWings = 73;
/*var hatmenu = document.createElement("div");
hatmenu.id = "hatmenu";
hatmenu.style = "position: absolute; overflow: scroll; z-index:1000; background-color:#68166fad; color: white; width:auto; height:auto;";
hatmenu.innerText = "Hat - Menu";
document.querySelector("#promoImgHolder").appendChild(hatmenu); */
document.getElementById("promoImgHolder").outerHTML = `
<div id="hatmenu" style="position: absolute; overflow: scroll; z-index: 1000; background-color: rgba(104, 22, 111, 0.68); color: white; width: auto; height: auto;">
<p style="text-align:center;">Hat - Menu</p><br />
<span> Bull Helmet + Blood Wings: </span>&nbsp;<input id="key1" type="text" style="border-radius:5px; margin-right:10px; text-align:center;" onclick="this.select();" value="k"/><br/ >
<span> Emp Helmet + Shadow Wings: </span>&nbsp;<input id="key2" type="text" style="border-radius:5px; margin-right:10px; text-align:center;" onclick="this.select();" value="i"/>
</div>
`;
document.getElementById("key1").onkeyup = (e)=>{
    bullHelmet_bloodWings = e.keyCode;
};
document.getElementById("key2").onkeyup = (e)=>{
    empHelmet_shadowWings = e.keyCode;
};
...
document.getElementById("daizo_menu").onmousemove = ()=>{
...
document.getElementById("leftClick").onclick = ()=>{
    var check = document.getElementById("leftClick");
    if (check.checked == true) {
        at1 = true;
    } else {
        at1 = false;
