...
//KeyCode event
    ...
    if (e.keyCode == 112 && autoQ == false && enter == false) {
        doNewSend(["ch",['Heal']]);
        e.preventDefault();
        autoQ = true;
    } else if (e.keyCode == 112 && autoQ == true && enter == false) {
        doNewSend(["ch",['Hel']]);
        e.preventDefault();
        autoQ = false;
    }
...
<span> Bull Helmet + Blood Wings: </span>&nbsp;<input id="key1" type="text" style="border-radius:5px; margin-right:10px; text-align:center;" onclick="this.select();" value="j"/><br/ >
